...
extern uint16_t b1minir4[417];
extern uint64_t b1startcat[417];


extern uint16_t tminir4[9992]; 
extern uint64_t minir4startcat[9993];
extern uint32_t minir4startr4[9993];
extern int GetMinir4id9992(int band,int * er4);
extern int GetMinir4id9992(int band, uint64_t rank);
extern void GetR4PointersFrom_minir4(int i9992, uint64_t& startcat,
